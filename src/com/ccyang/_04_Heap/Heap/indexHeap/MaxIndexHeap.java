...
public class MaxIndexHeap<Item extends Comparable> {
	...
	public void insert(int i, Item item) {
		...
		i += 1;
		data[i] = item;
		indexes[++count] = i; // 第 i 个元素，索引中就存放 i，，data[] 和 indexes[]均从1开始
		shiftUp(count);
	}
	...
	public static void main(String[] args) {
		...
		int N = 1000000;
		MaxIndexHeap<Integer> indexMaxHeap = new MaxIndexHeap<Integer>(N);
		for (int i = 0; i < N; i++)
