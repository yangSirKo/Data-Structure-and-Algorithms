...
public class Main {
	...
	public static void main(String[] args) {
		...
		SortUtil.testSort("com.atyang.merge.MergeSort2", arr2);
		...
		SortUtil.testSort("com.atyang.merge.MergeSort2", arr4);
		...
		SortUtil.testSort("com.atyang.merge.MergeSort2", arr6);
